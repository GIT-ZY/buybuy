                        ...
                        <div class="section clearfix">
                            ...
                            <div v-if="order.orderinfo" class="right-auto">
                                <div class="bg-wrap" style="min-height: 765px;">
                                    <div class="sub-tit">
                                        <a href="javascript:void(0)" @click="goBack" class="add">
                                    ...
                                    <div class="order-progress">
                                        <ul>
                                            ...
                                            <li :class="order.orderinfo.status >= 3?'active':''">
                                                ...
                                                <div class="info">{{order.orderinfo.confirm_time | dateFmt('YYYY-MM-DD HH:mm:ss')}}</div>
                                            </li>
                                            <li :class="[order.orderinfo.status >= 4?'active':'','last']">
                                    ...
                                    <div class="form-box accept-box form-box1">
                                        <dl class="head form-group">
                                            <dd>
                                                ...
                                                <router-link v-if="order.orderinfo.status==1" :to="'/site/payOrder/'+order.orderinfo.id" class="btn-pay">去付款</router-link>
                                                <!---->
                                            </dd>
                                        </dl>
                                        <dl class="form-group">
                                    ...
                                    <div class="table-wrap">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="5" class="ftable">
                                            <tbody>
                                                ...
                                                <tr v-for="goods in order.goodslist" :key="goods.id">
                                                    <td width="60">
                                                        <img :src="goods.imgurl" class="img">
                                                    </td>
                                                    <td align="left">
                                                        <a target="_blank" href="/goods/show-92.html">{{goods.goods_title}}</a>
                                                    </td>
                                                    <td align="center">
                                                    ...
                                                    <td align="center">￥{{goods.quantity * goods.real_price}}</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="7" align="right">
                                                        ...
                                                        <p style="font-size: 22px;">应付总金额：
                                                            <b class="red">￥{{needPayTotalPrice}}</b>
                                                        </p>
                                                    </td>
                                                </tr>
                                            </tbody>
...
<script>
    export default {
        data() {
            return {
                order: {},
                goodsTotalPrice:0,//商品总金额
                needPayTotalPrice:0 //应付总金额
            }
        },
        created() {
            ...
            getOrderInfoData() {
                ...
                this.$axios.get(url).then(response => {
                    ...
                    response.data.message.goodslist.forEach(item=>{
                        tempTotalPrice += item.quantity * item.real_price 
                    })
                    this.goodsTotalPrice = tempTotalPrice
                    this.needPayTotalPrice = this.goodsTotalPrice + response.data.message.orderinfo.express_fee
